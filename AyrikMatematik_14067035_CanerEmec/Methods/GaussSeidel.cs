...
namespace AyrikMatematik_14067035_CanerEmec
{
    class GaussSeidel
    {
        ...
        public delegate void NotifyEventHandler(object sender, GSeidelEventArgs e);
        ...
        public GaussSeidel(int n, string strA, string strC, double eps, int maxIter)
        {
            this.N = n;
            this.Eps = eps;
        ...
        public Result Solve()
        {
            ...
            while (err > Eps && result.iter_no < MaxIter)
            {
                ...
                if (OnNotify != null)
                {
                    GSeidelEventArgs args = new GSeidelEventArgs(result);
                    OnNotify(this, args);
                }
            }
        ...
        public class GSeidelEventArgs : EventArgs
        {
            public Result Result { get; set; }
            public GSeidelEventArgs(Result result)
            {
                this.Result = result;
            }
        }
