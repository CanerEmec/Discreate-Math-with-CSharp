...
namespace AyrikMatematik_14067035_CanerEmec
{
    class GaussElimination
    {
        ...
        public delegate void NotifyEventHandler(object sender, GEEventArgs e);
        ...
        public GaussElimination(int n, string strA, string strC)
        {
            this.N = n;
            MatA = new double[N, N];
            MatB = new double[N];
        ...
        public Result Solve()
        {
            ...
            for (int i = 0; i < N; i++)//rows
            {
                ...
                if (OnNotify != null)
                {
                    GEEventArgs args = new GEEventArgs(result);
                    OnNotify(this, args);
                }
        ...
        public class GEEventArgs : EventArgs
        {
            ...
            public GEEventArgs(Result result)
            {
                this.Result = result;
            }
        }
